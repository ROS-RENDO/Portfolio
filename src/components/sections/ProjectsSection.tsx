...
const PROJECTS = [
  {
    ...
    description: "A full-stack e-commerce solution with real-time inventory management, complete checkout flow, and a comprehensive admin dashboard.",
  ...
  },
  {
    id: 2,
    title: "TaskFlow Pro",
    description: "Real-time project management and task tracking application featuring WebSockets for instant updates, role-based access, and Kanban boards.",
  ...
  },
  {
    id: 3,
    title: "CryptoTracker",
    description: "Financial dashboard tracking real-time cryptocurrency markets, utilizing external REST APIs, responsive charting, and personalized watchlists.",
  ...
  },
  {
    ...
    description: "A dedicated social network for developers to share code snippets, find collaborators, and participate in community-driven technical discussions.",
      ...
      <div className="container mx-auto px-6 xl:pl-32">
        ...
        >
          <h2 className="font-space-grotesk text-4xl font-bold md:text-5xl">
            <span className="text-zinc-500">03.</span> Featured <span className="text-cyan-400 text-glow">Projects</span>
          </h2>
        ...
        >
          {PROJECTS.map((project) => (
            ...
            >
              ...
              <div className={`h-48 w-full bg-gradient-to-br ${project.color} relative overflow-hidden flex items-center justify-center p-6`}>
              ...
              <div className="flex flex-1 flex-col p-8">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <div className="flex space-x-3 text-zinc-400">
                    <a href={project.github} className="hover:text-cyan-400 transition-colors hover:drop-shadow-[0_0_8px_#06b6d4]">
                      <FiGithub size={22} />
                    </a>
                    <a href={project.demo} className="hover:text-cyan-400 transition-colors hover:drop-shadow-[0_0_8px_#06b6d4]">
        ...
        >
          <a href="#" className="inline-flex items-center gap-2 font-space-grotesk text-cyan-400 hover:text-cyan-300 transition-all text-glow border-b border-cyan-500/30 pb-1 hover:border-cyan-400">
